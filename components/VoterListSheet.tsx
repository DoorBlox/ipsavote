...
import { ArrowLeft, Printer, CheckSquare, Square, Calendar } from 'lucide-react';
...
const VoterListSheet: React.FC<VoterListSheetProps> = ({ voters, onBack }) => {
  ...
  const [electionDate, setElectionDate] = useState('FEBRUARY 21, 2026');
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-2 bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200">
              ...
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest mr-1">Date:</span>
              <input 
                type="text"
                value={electionDate}
                onChange={(e) => setElectionDate(e.target.value.toUpperCase())}
                className="bg-transparent border-none focus:ring-0 text-[10px] font-bold text-[#7b2b2a] w-32 uppercase placeholder:text-slate-300"
                  ...
                  <div className="flex items-center justify-between border-b-2 border-slate-900 pt-6 pb-6 mb-8 bg-white">
                    <div className="flex items-center gap-4 bg-white">
                      ...
                      <div className="bg-white">
                        ...
                        <p className="text-[10px] font-bold text-slate-500 mt-1 uppercase tracking-[0.1em]">IPSA General Election • 2026 </p>
                      </div>
                    </div>
                    <div className="text-right bg-white">
                      ...
                      <p className="text-sm font-black text-slate-800 uppercase">{electionDate || 'NOT SET'}</p>
                    </div>
                  </div>
                </td>
              </tr>

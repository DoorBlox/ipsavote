    ...
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="a4-container mx-auto bg-white shadow-2xl print:shadow-none print:m-0 mt-8">
        <div className="p-12">
                ...
                <td colSpan={4} className="pt-8">
                  <div className="flex justify-between items-end border-t border-slate-100 pt-4">
                    <div className="text-[9px] text-slate-400 font-medium uppercase tracking-widest">
                      ...
                      <div className="mt-1">&copy; 2026 Hisyam • 4EVER • International Program Student Association</div>
                    </div>
          ...
          {/* Signature Block: Only appears ONCE at the very end of the registry */}
          {processedVoters.length > 0 && (
            <div className="mt-32 flex flex-col gap-16 pb-12">
      ...
      <style>{`
        ...
        @media print {
          ...
          /* Ensure signature block doesn't split poorly */
          .mt-32 { 
